      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <button
            ...
            disabled={syncing}
            style={{
              background: syncing ? '#1e293b' : '#3b82f6',
              color: '#fff',
              border: 'none',
              borderRadius: 8,
              padding: '8px 14px',
          ...
          <button
            ...
            disabled={syncing}
            title="Full sync — re-fetches all orders from the beginning"
            style={{
              background: '#1e293b',
              color: '#94a3b8',
      ...
      {syncStatus && !loading && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 10, color: '#64748b', textTransform: 'uppercase', fontWeight: 600, marginBottom: 4 }}>
              Total Orders
            </div>
            <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'monospace' }}>
              {(syncStatus.totalOrders || 0).toLocaleString()}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'monospace', color: '#06b6d4' }}>
              {(syncStatus.shippedOrders || 0).toLocaleString()}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'monospace', color: '#f59e0b' }}>
              {(syncStatus.lastSyncId || 0).toLocaleString()}
            </div>
        ...
        <div style={{
          ...
          {result.timed_out && (
            <div style={{ marginTop: 8, fontSize: 11, color: '#f59e0b' }}>
              💡 Klik Sync lagi untuk melanjutkan dari posisi terakhir (incremental)
            </div>
          )}
        </div>
      )}
