...
export default function DashboardLayout({ children }) {
  ...
  const showDatePicker = !['admin', 'finance', 'customers', 'brand-analysis', 'warehouse', 'warehouse-settings', 'financial-report', 'cashflow', 'financial-settings', 'marketplace-intake', 'marketplace-mapping'].includes(currentTab);
...
function TabIcon({ id, size = 18 }) {
  ...
  switch(id) {
    ...
    case 'marketplace-mapping': return <svg {...s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 6l6-2 6 2 6-2v14l-6 2-6-2-6 2V6z"/><path d="M9 4v14"/><path d="M15 6v14"/></svg>;
