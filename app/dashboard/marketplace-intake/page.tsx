  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ fontSize: 13, color: 'var(--dim)', marginBottom: 18, maxWidth: 920 }}>
        ...
        mengklasifikasikan store final, lalu menaruh hasilnya ke <strong>workspace warehouse</strong>. Data baru dianggap valid downstream setelah warehouse memberi <strong>shipment date</strong>.
      </div>
