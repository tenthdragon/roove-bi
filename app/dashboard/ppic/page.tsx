...
export default function PPICPage() {
  ...
  return (
    <div style={{ padding: '0 0 40px', position: 'relative' }}>
      ...
      {/* Tab bar */}
      <div className="no-scrollbar" style={{ display: 'flex', gap: 4, marginBottom: 20, borderBottom: '1px solid var(--border)', paddingBottom: 0, overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
        {SUB_TABS.map(t => (
